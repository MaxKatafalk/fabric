...
namespace fabric.Forms
{
    public class OrderForm : Form
    {
        ...
        private void LoadOrders()
        {
            ...
            {
                _listBoxOrders.Items.Add($"{o.Id}: {o.OrderNumber} | {o.CustomerName} | {o.Status} | {o.OrderDate.ToShortDateString()}");
            }
        }
        ...
        private void ButtonCreate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Поле примечание обязательно");
                return;
            }
